...
Froala loves to welcome your contributions. There are several ways to help out:
...
Froala tests requires [PHPUnit](http://www.phpunit.de/manual/current/en/installation.html)
3.5 or higher. To run the testcases locally use the following command:

    ./lib/Cake/Console/cake test Froala AllFroala

To run the sniffs for CakePHP coding standards

    phpcs -p --extensions=php --standard=CakePHP ./app/Plugin/Froala
...
* [Bug tracker](https://github.com/stefanneculai/wysiwyg-cake/issues)
